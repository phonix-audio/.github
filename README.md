...
![The arrangement, with the automation lane and the generative panel](profile/sequencer.png)
...
![Cordis: the piano seen from above, its microphones on the soundboard](profile/cordis.png)
...
This repository is the organisation's public face and carries no code.
`profile/README.md` is what renders at
[github.com/phonix-audio](https://github.com/phonix-audio) while it is public;
`profile/logo.py` generates the mark.
